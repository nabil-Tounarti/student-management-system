...
const { findAllStudents, findStudentDetail, findStudentToSetStatus, addOrUpdateStudent, removeStudent } = require("./students-repository");
...
const deleteStudent = async (id) => {
    ...
    const affectedRow = await removeStudent(id);
    if (affectedRow <= 0) {
